...
class HrCandidatesPage extends StatefulWidget {
  const HrCandidatesPage({super.key, required this.controller});

  static const routeName = '/hr-candidates';

  final EmployerDashboardController controller;

  @override
  State<HrCandidatesPage> createState() => _HrCandidatesPageState();
}

class _HrCandidatesPageState extends State<HrCandidatesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return HrScaffold(
      selectedItem: HrNavigationItem.candidates,
      body: CustomScrollView(
        key: const ValueKey('hrCandidatesPage'),
        slivers: [
          SliverPadding(
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Aday, pozisyon veya yetenek ara',
                          prefixIcon: const Icon(Icons.search_rounded),
                          suffixIcon: IconButton(
                            key: const ValueKey('hrCandidateFilterButton'),
                            tooltip: 'Filtreler',
                ...
                itemBuilder: (context, index) => Center(
                  child: ConstrainedBox(
                    ...
                    child: _CandidateCard(
                      key: ValueKey('hrCandidateCard$index'),
  ...
  List<_HrCandidate> _visibleCandidates() {
    final matches = widget.controller.dashboard.topMatches;
    final candidates = <_HrCandidate>[
      _HrCandidate(
    ...
    return showModalBottomSheet<void>(
      ...
      builder: (sheetContext) => StatefulBuilder(
        builder: (context, setSheetState) => SafeArea(
          top: false,
          child: Padding(
            key: const ValueKey('hrCandidateFilterSheet'),
...
class _CandidateCard extends StatelessWidget {
  ...
  _StageStyle _styleFor(_CandidateStage stage) {
    return switch (stage) {
      _CandidateStage.all => const _StageStyle(
        label: 'Tümü',
        foreground: AppColors.primary,
        surface: AppColors.surfaceHighest,
      ),
      _CandidateStage.screening => const _StageStyle(
        label: 'Ön Eleme',
        foreground: Color(0xFF2563EB),
        surface: Color(0xFFEFF6FF),
      ),
      _CandidateStage.interview => const _StageStyle(
        label: 'Mülakat',
        foreground: Color(0xFFB45309),
        surface: Color(0xFFFFF7ED),
      ),
      _CandidateStage.offer => const _StageStyle(
        label: 'Teklif',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 5),
            Text(
              'Arama kelimesini veya filtreleri değiştirmeyi dene.',
