...
class LocalDashboardDataSource implements DashboardDataSource {
  ...
  CandidateDashboardModel getCandidateDashboard() {
    return const CandidateDashboardModel({
      ...
      'applicationHistory': <Map<String, Object>>[
        {
          'role': 'Senior Frontend Engineer',
          'company': 'Stripe',
          'location': 'San Francisco',
          'status': 'Interviewing',
          'stageLabel': '2. görüşme / 4',
          'progress': .5,
          'nextStep': 'Sıradaki: Teknik değerlendirme',
        },
        {
          'role': 'Staff UX Designer',
          'company': 'Airbnb',
          'location': 'Remote',
          'status': 'Applied',
          'stageLabel': 'İnceleniyor',
          'progress': .25,
          'nextStep': 'Başvuru gönderildi',
        },
        {
          ...
          'location': 'Remote',
          'status': 'Rejected',
          'stageLabel': 'Başvuru sonuçlandı',
          'progress': 1.0,
          'nextStep': 'Başvuru olumsuz sonuçlandı',
        },
      ],
